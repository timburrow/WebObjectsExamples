...
#
#    Synopsis:
#	Construct plist from 2 models: School.eomodeld and Course.eomodeld.
#	Capture data from "School" database, and all tables for "School"
#	"Course" entities. The "SophisticatedDatabaseExample.plist" will
#	be included in the example so that the database can be constructed.
#	-scavin
#
...
do
    ...
    $eoutil dump $model -source database -dest plist $plist -modelGroup $models $nonstop -WODebuggingEnabled TRUE -EOAdaptorDebugEnabled FALSE
